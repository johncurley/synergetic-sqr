...
## Quantifying Hysteresis-Zero and Dielectric Henosis (v2.9.11)
...
### 2. Anabasis Power Drop Test (FPGA Emulation)
*   **Method:** Execute the Anabasis boot sequence on the Arty A7 while monitoring the current draw on the 1.0V core rail.
*   **Metric:** $\Delta P$ between 'Phase 1: Precessional Lift' and 'Phase 4: Henosis'.
...
*   **Purpose:** To confirm the 'Purple Glow' as a controllable dielectric discharge. 
*   **Safety Guard:** Uncontrolled glow indicates dielectric stress; Henosis is achieved when the glow stabilizes as a steady nav-lattice.
