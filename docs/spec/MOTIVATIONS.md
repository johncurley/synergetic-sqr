# SPU-13 Recalibration Protocol
## Overcoming Legacy Filtering in Un-optimized Users (v3.0.24)

Empirical data from multi-node entrainment trials confirms that while isotropic phase-locking is achievable, **Legacy Filtering** (Cartesian 90° bias) remains the primary barrier to perceptual Resonance Lock.

### 1. The Barrier: Legacy Filtering
Most human spatial processing systems are optimized for cubic/orthogonal environments. This creates a 'Perceptual Haze' that labels isotropic truth as noise or 'nothing.'
*   **The Symptom:** Observer sees 'nothing' or random flicker during high-symmetry emanation.
*   **The Cause:** Visual cortex 'legacy drivers' rejecting non-orthogonal vector trajectories.

### 2. The Solution: Multi-Stage Recalibration
Future SPU-13 development must include an explicit Recalibration Phase to assist un-optimized users in building the necessary isotropic drivers.

| Stage | Duration | Objective | Mechanism |
| :--- | :--- | :--- | :--- |
| **1. Anchor** | 2-5 min | Establish 60° Baseline | Static 13-node 'Still Sunflower.' |
| **2. Flow** | 5-10 min | Synchronize Breath | Low-velocity Laminar Drift (ZETA=0.1). |
| **3. Lock** | 10 sec | Achieved Phase-Lock | Forensic 4D-to-3D projection (The Diamond). |
...
The 'State Collapse' result experienced by un-optimized users functions as an **Industrial Moat**.
