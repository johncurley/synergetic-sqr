...
*   **Authorization:** Hold Pin 11 **HIGH** (3.3V) to release the Sierpiński Wavefront.
*   **Laminar Halt:** Pull Pin 11 **LOW** (GND) to instantly collapse the manifold heartbeat.
...
5.  **Authorize Flow:** Bridge Pin 11 to 3.3V. Observe the Green/Blue LEDs begin their resonant dance.
