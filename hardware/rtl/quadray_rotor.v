...
module quadray_rotor (
    ...
    spu_smul rotor_scale_1 (.a1(q1_in[31:0]), .b1(q1_in[63:32]), .a2(surd_ratio[15:0]), .b2(surd_ratio[31:16]), .res_a(m1[31:0]), .res_b(m1[63:32]));
    spu_smul rotor_scale_2 (.a1(q2_in[31:0]), .b1(q2_in[63:32]), .a2(surd_ratio[15:0]), .b2(surd_ratio[31:16]), .res_a(m2[31:0]), .res_b(m2[63:32]));
    spu_smul rotor_scale_3 (.a1(q3_in[31:0]), .b1(q3_in[63:32]), .a2(surd_ratio[15:0]), .b2(surd_ratio[31:16]), .res_a(m3[31:0]), .res_b(m3[63:32]));
    spu_smul rotor_scale_4 (.a1(q4_in[31:0]), .b1(q4_in[63:32]), .a2(surd_ratio[15:0]), .b2(surd_ratio[31:16]), .res_a(m4[31:0]), .res_b(m4[63:32]));
