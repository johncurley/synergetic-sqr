// ULX3S Gemini Manifold (v1.2 Sovereign Parity)
// Target: Lattice ECP5-85F
// Objective: Dual-Core Mutual Witnessing on the high-performance node.
...
module ulx3s_top (
    ...
    // --- 1. Resonant Heart (25MHz Source) ---
    spu_resonant_heart #(.CLK_IN_HZ(25000000)) u_heart (
    ...
    spu_gemini_manifold #(.CLK_HZ(25000000)) u_gemini (
    ...
    spu_whisper_sane #(.CLK_HZ(25000000)) u_sane (
